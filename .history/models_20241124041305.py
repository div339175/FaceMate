...
class Developer(db.Model, BaseModel):
...
class Student(db.Model, BaseModel):
    ...
    batch = dbfrom flask_sqlalchemy import SQLAlchemy
from flask_login import UserMixin
from datetime import datetime
...
class AttendanceSession(db.Model, BaseModel):
...
class AttendanceRecord(db.Model, BaseModel):
    ...
    student = db.relationship('Student', backref='attendance_records')DateTime, nullable=True)
