...
class Student(db.Model):
    ...
    # Link to courses (many-to-many relationship)
    courses = db.relationship('Course', secondary='student_course', backref='enrolled_students', lazy='dynamic')
...
class Course(db.Model):
    ...
    students = db.relationship('Student', secondary='student_course', backref='enrolled_courses', lazy='dynamic')
