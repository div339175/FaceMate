    ...
    try:
        ...
        with open(csv_file, mode='w', newline='', encoding='utf-8') as file:
            ...
            for student in students:
                # Access photo directly from the Student object
                photo_url = student.photo if student.photo else "N/A"  # Default to 'N/A' if no photo
                                # photo_url = f"/path/to/photos/{student.photo}" if student.photo else "N/A"
