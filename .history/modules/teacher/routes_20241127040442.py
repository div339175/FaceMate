...
<script>
        ...
        function saveAttendance() {
            ...
            fetch('/teacher/save_attendance', {
                ...
                body: JSON.stringify({ attendance_data: attendanceData, batch_id: '{{ batch_id }}' })
            })
        ...
        function downloadCSV() {
            window.location.href = '/teacher/download_csv?batch_id={{ batch_id }}';
        }
