...
teacher_bp.get('/teacher/attendance_data', async (req, res) => {
    const batchId = req.query.batch_id;
    const courseId = req.query.course_code;

    // Fetch attendance data from the database
    const attendanceData = await Attendance.find({ batch_id: batchId, course_code: courseId });
