from flask import send_file,io, render_template,jsonify,request, redirect, url_for, flash
...
@teacher_bp.route('/teacher/attendance_data', methods=['GET'])
...
@teacher_bp.route('/teacher/save_attendance', methods=['POST'])
def save_attendance():
    try:
