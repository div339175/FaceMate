...
import os
import csv
from models import Student, StudentCourse  # Assuming these are your model imports
    ...
    try:
        ...
        with open(csv_file, mode='w', newline='', encoding='utf-8') as file:
            ...
            for student in students:
                # Access photo_url directly from the Student object
                photo_url = student.photo_url if hasattr(student, 'photo_url') else "N/A"
