...
def train_data():
    ...
    photo_samples_path = os.path.abspath(f"modules/developer/static/uploads/{roll_no}"/'photo_samples')
    ...
    if faces and labels:
        ...
        classifier_path=f'modules/student/static/uploads/{roll_no}/classifier_{roll_no}.xml'
