...
from models import User,te

developer_bp = Blueprint('developer_bp', __name__, template_folder='templates')
...
def login():
    if request.method == 'POST':
        ...
        if user and user.password == password:
            login_user(user)
            return redirect(url_for('developer_bp.developer_dashboard'))
