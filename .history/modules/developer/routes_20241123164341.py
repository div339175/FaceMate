        ...
        if User.query.filter_by(email=email).first():
            ...
            try:
                ...
                if photo:
                    ...
                    photo_path = os.path.join('static/uploads/',photo_filename# modules/developer/routes.py
import cv2
from  import Blueprint, render_template, request, redirect, url_for, flash, jsonify
from flask_login import logout_user, login_user, login_required, current_user
from models import Developer, Teacher, Student, db, User
from . import develope)
