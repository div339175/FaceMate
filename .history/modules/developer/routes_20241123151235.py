...
def train():
    ...
    # Corrected path
    photo_samples_path = os.path.join("modules/developer/static/uploads", roll_no, "photo_samples")
    ...
    if faces and labels:
        ...
        classifier_dir = os.path.join("modules/developer/static/uploads", roll_no)
