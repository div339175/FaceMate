...
def register_student():
    ...
    if request.method == 'POST':
        ...
        course_id = request.form['courses']  # JSON string of course IDs
        ...
        for course_id in selected_course_ids:
            student_course = StudentCourse(roll_number=roll_number,course_name=course_name,course_id=course_id)
