...
import base64
import numpy as np
from models import Student,db,AttendanceSession,Attendance
...
def student_dashboard():
    ...
    if not student:
        ...
        return redirect(url_for('student.login'))
    active_session = get_active_session(student.course)  # Assuming course is linked to Student
    ...
    try:
        ...
        if face_recognized:
            ...
            new_attendance = Attendance(
                ...
                batch=student.batch_id,  # Assuming year represents batch
                status="Present",
