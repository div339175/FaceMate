...
def student_dashboard():
    ...
    return render_template('student_dashboard.html', student=student, active_sessions=active_sessions_dict)
...
def recognize_face():
    try:
        ...
        active_session = get_active_session(student_course.course_code)
