...
class StudentCourse(db.Model):
    ...
    course_name = db.Column(db.String(120), nullable=False)  # Store course name directly
    course_code = db.Column(db.String(50), nullable=False)  # Replace course_id with course_code
